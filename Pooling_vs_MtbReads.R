...
THP1_1e6_PoolVsReads <- my_pipeSummary %>% 
  ...
  labs(title = "Pooled for Capture vs number reads aligned to Mtb",
...
ggsave(HP1_1e6_PoolVsPercentReads,
       file = "PoolVsPercentReads_THP1_1e6.pdf",
       path = "Pooling_Figures",
       width = 6, height = 4, units = "in")
...
ggsave(newTHP1_PoolVsPercentReads,
       file = "PoolVsPercentReads_newTHP1.pdf",
       path = "Pooling_Figures",
       width = 6, height = 4, units = "in")
